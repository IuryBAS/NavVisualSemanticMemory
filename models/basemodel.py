...
class BaseModel(torch.nn.Module):
    def __init__(self, args):
        ...
        self.hidden_state_sz = lstm_input_sz #hidden_state_sz
        #self.lstm = nn.LSTMCell(lstm_input_sz, hidden_state_sz)
        num_outputs = action_space
        self.critic_linear = nn.Linear(self.hidden_state_sz, 1)
        self.actor_linear = nn.Linear(self.hidden_state_sz, num_outputs)
    ...
    def a3clstm(self, embedding, params):
        if params is None:
    ...
    def forward(self, model_input, model_options):
        ...
        actor_out, critic_out = self.a3clstm(x, params)
